  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-slate-100 dark:bg-[#0a0a0a]/90 dark:border-[#ffffff1a]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <a href="#topo" className="flex items-center gap-2" aria-label="Food Share, ir para o topo">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="md:hidden w-11 h-11 shrink-0 rounded-lg flex items-center justify-center text-slate-600 hover:bg-slate-100 dark:text-[#a3a3a3] dark:hover:bg-[#1a1a1a] transition-colors"
          >
